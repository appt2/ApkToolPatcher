...
public class FastScroller extends FrameLayout {
    ...
    private void initialise(@NonNull Context context) {
        ...
        setPressedHandleColor(App.getColorFromAttr(getContext(), com.google.android.material.R.attr.colorAccent));
        setUpBarBackground();
    ...
    private void setUpBarBackground() {
        ...
        int resolveColor = resolveColor(getContext(), com.google.android.material.R.attr.colorControlNormal);
