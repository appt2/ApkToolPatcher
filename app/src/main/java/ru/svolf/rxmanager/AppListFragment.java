...
public class AppListFragment extends ListFragment
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    Log.d(
        TAG,
        "onViewCreated() called with: view = ["
            + view
            + "], savedInstanceState = ["
            + savedInstanceState
            + "]");
  ...
  public void onActivityCreated(Bundle savedInstanceState) {
    Log.d(
        TAG, "onActivityCreated() called with: savedInstanceState = [" + savedInstanceState + "]");
  ...
  public void onListItemClick(ListView listView, View view, int position, long id) {
    Log.d(
        TAG,
        "onListItemClick() called with: listView = ["
            + listView
            + "], view = ["
            + view
            + "], position = ["
    ...
    AppsDetailsFragment detailsFragment =
        AppsDetailsFragment.newInstance(appBasicData.getPackageName(), null);
  ...
  public void onClick(View v) {
    ...
    if(v.getId() == R.id.btn_analyze_not_installed) {
  ...
  private void startFilePicker(boolean withPermissionCheck) {
    Log.d(
        TAG, "startFilePicker() called with: withPermissionCheck = [" + withPermissionCheck + "]");
  ...
  class ExtractionTask extends AsyncTask<Intent, File, File> {
    ...
    protected File doInBackground(final Intent... intents) {
      ...
      RealPathUtils.streamToFile(
          FilePickHelper.onActivityResult(getContext(), intents[0]).get(0).getFileStream(),
          archive);
      return archive;
    }
