...
public class ClassMaker extends SmaliBaseVisitor<Object> {
  ...
  public static final ClassDef make(File file, Opcodes opcodes) throws IOException {
    return make(file.getAbsolutePath(), opcodes);
  }
  ...
  public static ClassDef make(
      SmaliParser.SmaliContext smali, CommonTokenStream tokens, Opcodes opcodes) {
  ...
  public ImmutableClassDef visitSmali(SmaliParser.SmaliContext ctx) {
    ...
    ImmutableSortedSet.Builder<ImmutableField> staticFields =
        new ImmutableSortedSet.Builder<ImmutableField>(neturalField);
    ImmutableSortedSet.Builder<ImmutableField> instanceFields =
        new ImmutableSortedSet.Builder<ImmutableField>(neturalField);
    Comparator<ImmutableMethod> neturalMethod = Ordering.natural();
    ImmutableSortedSet.Builder<ImmutableMethod> directMethods =
        new ImmutableSortedSet.Builder<ImmutableMethod>(neturalMethod);
    ImmutableSortedSet.Builder<ImmutableMethod> virtualMethods =
        new ImmutableSortedSet.Builder<ImmutableMethod>(neturalMethod);
    for (SmaliParser.MemberContext member : ctx.member()) {
      if (member instanceof SmaliParser.ClassAltContext)
        ...
        if (FieldUtil.isStatic(field)) staticFields.add(field);
        ...
        if (MethodUtil.isDirect(method)) directMethods.add(method);
        else virtualMethods.add(method);
      }
    }
  ...
  public ImmutableMethod visitMethod(SmaliParser.MethodContext ctx) {
    ...
    MethodImplementationBuilder implBuilder =
        buildInstruction(ctx.statement_or_directive(), annotations, paramtersArray, isStatic);
    ...
    ImmutableMethodImplementation implementation = null;
    if (implBuilder != null)
      implementation = ImmutableMethodImplementation.of(implBuilder.getMethodImplementation());
  ...
  private MethodImplementationBuilder buildInstruction(
      List<SmaliParser.Statement_or_directiveContext> statement_or_directive,
    ...
    for (SmaliParser.Statement_or_directiveContext ctx : statement_or_directive) {
      if (ctx instanceof SmaliParser.RegisterAltContext) {
        ...
        annotations.add(
            visitAnnotation(((SmaliParser.MethodAnnotationAltContext) ctx).annotation()));
      else if (ctx instanceof SmaliParser.ParamterAltContext)
        setParameter((SmaliParser.ParamterAltContext) ctx, paramtersArray);
      else addInstructionOrDirectives(ctx, builder, localsCount);
    }
    return builder;
  }

  private void addInstructionOrDirectives(
      SmaliParser.Statement_or_directiveContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
    if (builder == null) throw new NullPointerException(".register or .locals must be at first!");
    ...
    else if (ctx instanceof SmaliParser.PrologueAltContext) builder.addPrologue();
    else if (ctx instanceof SmaliParser.EpilogueAltContext) builder.addEpilogue();
  ...
  private void addInstruction(
      SmaliParser.Instruction51lAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction4rccMethodAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
    ...
    BuilderInstruction instruction =
        new BuilderInstruction4rcc(opcode, registers[0], registers[1], method, proto);
    builder.addInstruction(instruction);
  }

  private void addInstruction(
      SmaliParser.Instruction45ccMethodAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction3rcTypeAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
    ...
    BuilderInstruction instruction =
        new BuilderInstruction3rc(opcode, registers[0], registers[1], reference);
    builder.addInstruction(instruction);
  }

  private void addInstruction(
      SmaliParser.Instruction3rcMethodAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction3rcCallsiteAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private int[] visitRegister_range(SmaliParser.Register_rangeContext range, int localsCount) {
    if (range == null) return NULL_RANGE;
  ...
  private void addInstruction(
      SmaliParser.Instruction35cTypeAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction35cMethodAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction35cCallsiteAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  @Override
  public ImmutableCallSiteReference visitCallsiteReference(
      SmaliParser.CallsiteReferenceContext ctx) {
    ...
    return new ImmutableCallSiteReference(name, methodHandle, methodName, proto, args.build());
  }
  ...
  private void addInstruction(
      SmaliParser.Instruction32xAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.InstructionPackedSwitchAltContext ctx, MethodImplementationBuilder builder) {
  ...
  private void addInstruction(
      SmaliParser.InstructionSparseSwitchAltContext ctx, MethodImplementationBuilder builder) {
  ...
  private void addInstruction(
      SmaliParser.InstructionArraydataAltContext ctx, MethodImplementationBuilder builder) {
  ...
  private void addInstruction(
      SmaliParser.Instruction31tAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction31iAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction31cAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
    ...
    Opcode opcode = opcodes.getOpcodeByName(opcodeString);
    int register = getRegister(insn.REGISTER(), localsCount);
    ImmutableReference ref = new ImmutableStringReference(parseStringOrChar(insn.STRING_LITERAL()));
    BuilderInstruction instruction = new BuilderInstruction31c(opcode, register, ref);
    builder.addInstruction(instruction);
  }

  private void addInstruction(
      SmaliParser.Instruction30tAltContext ctx, MethodImplementationBuilder builder) {
  ...
  private void addInstruction(
      SmaliParser.Instruction23xAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
    ...
    BuilderInstruction instruction =
        new BuilderInstruction23x(opcode, register1, register2, register3);
    builder.addInstruction(instruction);
  }

  private void addInstruction(
      SmaliParser.Instruction22xAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction22tAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction22sAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
    ...
    BuilderInstruction instruction =
        new BuilderInstruction22s(opcode, register1, register2, literal);
    builder.addInstruction(instruction);
  }

  private void addInstruction(
      SmaliParser.Instruction22cTypeAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
    ...
    ImmutableReference reference =
        new ImmutableTypeReference(tokens.getText(insn.nonvoid_type_descriptor()));
    BuilderInstruction instruction =
        new BuilderInstruction22c(opcode, register1, register2, reference);
    builder.addInstruction(instruction);
  }

  private void addInstruction(
      SmaliParser.Instruction22cFieldAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction22bAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
    ...
    int literal = visitIntegralLiteral(insn.integralLiteral()).intValue();
    BuilderInstruction instruction =
        new BuilderInstruction22b(opcode, register1, register2, literal);
    builder.addInstruction(instruction);
  }

  private void addInstruction(
      SmaliParser.Instruction21tAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction21sAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction21lhAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  public Number visitFixed64bitLiteral(SmaliParser.Fixed64bitLiteralContext ctx) {
    int type = ctx.type;
    if (type == 1) return LiteralTools.parseInt(tokens.getText(ctx.integerLiteral()));
    if (type == 2) return LiteralTools.parseLong(ctx.LONG_LITERAL().getText());
    if (type == 3) return LiteralTools.parseShort(ctx.SHORT_LITERAL().getText());
    if (type == 4) return LiteralTools.parseByte(ctx.BYTE_LITERAL().getText());
    if (type == 5) return LiteralTools.parseFloat(tokens.getText(ctx.floatLiteral()));
    if (type == 6) return LiteralTools.parseDouble(tokens.getText(ctx.doubleLiteral()));
    if (type == 7) return (int) parseStringOrChar(ctx.CHAR_LITERAL()).charAt(0);
    if (type == 8) return Boolean.valueOf(ctx.BOOL_LITERAL().getText()) ? 1 : 0;
    return 0;
  }

  private void addInstruction(
      SmaliParser.Instruction21ihAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  public Number visitFixed32bitLiteral(SmaliParser.Fixed32bitLiteralContext ctx) {
    int type = ctx.type;
    if (type == 1) return LiteralTools.parseLong(ctx.LONG_LITERAL().getText());
    if (type == 2) return LiteralTools.parseInt(tokens.getText(ctx.integerLiteral()));
    if (type == 3) return LiteralTools.parseShort(ctx.SHORT_LITERAL().getText());
    if (type == 4) return LiteralTools.parseByte(ctx.BYTE_LITERAL().getText());
    if (type == 5) return LiteralTools.parseFloat(tokens.getText(ctx.floatLiteral()));
    if (type == 6) return (int) parseStringOrChar(ctx.CHAR_LITERAL()).charAt(0);
    if (type == 7) return Boolean.valueOf(ctx.BOOL_LITERAL().getText()) ? 1 : 0;
    return 0;
  }

  private void addInstruction(
      SmaliParser.Instruction21cTypeAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction21cStringAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction21cMethodAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction21cMethodHandleAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction21cFieldAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction20tAltContext ctx, MethodImplementationBuilder builder) {
  ...
  private void addInstruction(
      SmaliParser.Instruction20bcAltContext ctx, MethodImplementationBuilder builder) {
    SmaliParser.Insn_format20bcContext insn = ctx.insn_format20bc();
    String opcodeString = insn.INSTRUCTION_FORMAT20bc().getText();
    Opcode opcode = opcodes.getOpcodeByName(opcodeString);
    int type = VerificationError.getVerificationError(insn.VERIFICATION_ERROR_TYPE().getText());
    ImmutableReference reference =
        visitVerification_error_reference(insn.verification_error_reference());
    BuilderInstruction instruction = new BuilderInstruction20bc(opcode, type, reference);
    builder.addInstruction(instruction);
  }

  public ImmutableReference visitVerification_error_reference(
      SmaliParser.Verification_error_referenceContext ctx) {
    if (ctx instanceof SmaliParser.TypeErrorAltContext) {
      ...
      return new ImmutableTypeReference(typeError.CLASS_DESCRIPTOR().getText());
    }
  ...
  private void addInstruction(
      SmaliParser.Instruction12xAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction11xAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction11nAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addInstruction(
      SmaliParser.Instruction10xAltContext ctx, MethodImplementationBuilder builder) {
  ...
  private void addInstruction(
      SmaliParser.Instruction10tAltContext ctx, MethodImplementationBuilder builder) {
  ...
  private void addRestartLocal(
      SmaliParser.RestartLocalAltContext ctx,
      MethodImplementationBuilder builder,
      int localsCount) {
  ...
  private void addEndLocal(
      SmaliParser.EndLocalAltContext ctx, MethodImplementationBuilder builder, int localsCount) {
  ...
  private void addStartLocal(
      SmaliParser.LocalAltContext ctx, MethodImplementationBuilder builder, int localsCount) {
    ...
    if (localDirective.name == null) name = null;
    else name = new ImmutableStringReference(parseStringOrChar(localDirective.name.getText()));
    ImmutableTypeReference type;
    if (localDirective.type == null) type = new ImmutableTypeReference("V");
    else type = new ImmutableTypeReference(tokens.getText(localDirective.type));
    ImmutableStringReference signtuare = null;
    if (localDirective.signature != null)
      signtuare =
          new ImmutableStringReference(parseStringOrChar(localDirective.signature.getText()));
  ...
  private void addCatchAll(
      SmaliParser.CatchAllAltContext ctx, MethodImplementationBuilder builder) {
  ...
  private void setParameter(
      SmaliParser.ParamterAltContext ctx, SmaliMethodParamter[] paramtersArray) {
    ...
    paramter.setName(parseStringOrChar(parameterDirective.STRING_LITERAL()));
  ...
  private int newBuilder(SmaliParser.RegisterAltContext ctx, int paramtersCount) {
    ...
    if (register.isLocal) count += paramtersCount;
    return count;
  }
  ...
  public Number visitIntegralLiteral(SmaliParser.IntegralLiteralContext ctx) {
    ...
    switch (ctx.type) {
      ...
      case 3:
        ...
        break;
      case 4:
        int ch = parseStringOrChar(ctx.CHAR_LITERAL()).charAt(0);
        num = ch;
        break;
      case 5:
  ...
  private static SmaliMethodParamter[] makeParametersArray(
      List<? extends CharSequence> parameterTypes, boolean isStatic) {
  ...
  public ImmutableField visitField(SmaliParser.FieldContext ctx) {
    ...
    ImmutableSet.Builder<ImmutableAnnotation> annotations = new ImmutableSet.Builder<>();
    for (SmaliParser.AnnotationContext a : ctx.annotation()) annotations.add(visitAnnotation(a));
  ...
  @Override
  public ImmutableAnnotationElement visitAnnotation_element(
      SmaliParser.Annotation_elementContext ctx) {
    String name = tokens.getText(ctx.simpleName());
  ...
  @Override
  public ImmutableEncodedValue visitMethodHandleLiteralAlt(
      SmaliParser.MethodHandleLiteralAltContext ctx) {
    return visitMethodHandleLiteral(ctx.methodHandleLiteral());
  }

  @Override
  public ImmutableEncodedValue visitMethodHandleLiteral(
      SmaliParser.MethodHandleLiteralContext ctx) {
    ImmutableMethodHandleReference reference =
        visitMethodHandleReference(ctx.methodHandleReference());
    return new ImmutableMethodHandleEncodedValue(reference);
  }

  @Override
  public ImmutableMethodHandleReference visitMethodHandleReference(
      SmaliParser.MethodHandleReferenceContext ctx) {
    ...
    else reference = visitMethodReference(ctx.methodReference());
  ...
  public ImmutableMethodReference visitMethodReference(SmaliParser.MethodReferenceContext ctx) {
    ...
    return new ImmutableMethodReference(
        defClass, name, proto.getParameterTypes(), proto.getReturnType());
  }

  @Override
  public ImmutableEncodedValue visitMethodProtoLiteralAlt(
      SmaliParser.MethodProtoLiteralAltContext ctx) {
    ImmutableMethodProtoReference proto = visitMethodProto(ctx.methodProto());
  ...
  public ImmutableList<CharSequence> visitParamList(SmaliParser.ParamListContext ctx) {
    ...
    for (SmaliParser.ParamArgContext arg : ctx.paramArg()) {
      if (arg instanceof SmaliParser.TypeAltContext) addArg((SmaliParser.TypeAltContext) arg, list);
      else addArg(arg, list);
    }
    return list.build();
  }
  ...
  private String getDefClass(
      SmaliParser.Reference_type_descriptorContext reference_type_descriptor) {
    if (reference_type_descriptor == null) return thisType;
  ...
  @Override
  public ImmutableEncodedValue visitSubAnnotationLiteralAlt(
      SmaliParser.SubAnnotationLiteralAltContext ctx) {
  ...
  public ImmutableEncodedValue visitArrayLiteral(SmaliParser.ArrayLiteralContext ctx) {
    ...
    SmaliParser.ArrayMemberContext array = ctx.arrayMember();
    if (array != null) {
      for (SmaliParser.LiteralContext literal : array.literal()) values.add(visitLiteral(literal));
    }
