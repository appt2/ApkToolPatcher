...
public class FileUtils {
  public static void open(File file, View view, final Refreshable refresh) {
    ...
    } else Toast.makeText(view.getContext(), n, Toast.LENGTH_SHORT).show();
  }
    ...
    PopupUtils.show(
        ...
        new PopupUtils.Callback() {
          ...
          public void call(Context ctx, int pos) {
            ...
            } else if (pos == R.id.rename) {
              rename(ctx, refresh, file);
            } else if (pos == R.id.copy_path) {
              ClipboardManager cm =
